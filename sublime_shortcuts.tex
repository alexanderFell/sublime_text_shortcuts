%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% sublime_shortcuts (c) by Alexander Fell
%
% sublime_shortcuts is licensed under a
...
\begin{tikzpicture}
	\put (198,12) {\includegraphics[scale=0.5]{cc-by-sa.png}};
\end{tikzpicture}
...
\begin{tcolorbox}[boxrule=0pt,sharp corners,parbox=false,colback=Black!10!white]
	...
	\begin{tabular}{@{}ll@{}}
		...
		\keys{\Alt + /}, \keys{\ctrl + \space}					& show auto complete\\
		\keys{\shift + \tab}									& insert tab without auto complete\\
		\keys{\shift + \enter}									& auto indent tag\\
	\end{tabular}
\end{tcolorbox}
\end{multicols}
...
\begin{tcolorbox}[boxrule=0pt,sharp corners,parbox=false,colback=OliveGreen!10!white]
	...
	%TODO: I could not get the footnotemark working somehow.
	\begin{tabular}{@{}ll@{}}
		\keys{\ctrl + S}										& Stash\\
	...
	\end{tabular}
	\footnotetext[1]{Custom configuration}
\end{tcolorbox}

\begin{tcolorbox}[boxrule=0pt,sharp corners,parbox=false,colback=blue!10!white]
	\section{\color{blue}Navigate}
	\begin{tabular}{@{}ll@{}}
		\keys{\Alt + \arrowkeyleft}								& Go back\\
		\keys{\Alt + \arrowkeyright}							& Go forward \\
		\keys{\Alt + \arrowkeyup}								& Go to child\\
		\keys{\Alt + \arrowkeydown}								& Go to parent \\
		\keys{\ctrl + 9} 										& Go to commit changes\\
		\keys{\ctrl + 0}		 								& Go to HEAD\\
		\keys{\ctrl + R}		 								& Navigate to branch\\
		\keys{\ctrl + F}		 								& Search\\
	\end{tabular}
\end{tcolorbox}

\begin{tcolorbox}[boxrule=0pt,sharp corners,parbox=false,colback=BurntOrange!10!white]
	\section{\color{BurntOrange}Tools}
	\begin{tabular}{@{}ll@{}}
		\keys{\ctrl + P}										& Command palette\\
		\keys{\ctrl + \shift + H}								& Refresh\\
		\keys{\ctrl + \textasciigrave}							& Toggle console\\
	\end{tabular}
\end{tcolorbox}
\end{multicols}
